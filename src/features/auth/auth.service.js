...
const register = async ({ name, email, password }) => {
  ...
  await sendMail(
    email,
    "Verify your Rabin's Photography account",
...
const forgotPassword = async (email) => {
  ...
  await sendMail(
    email,
    "Reset your Rabin's Photography password",
